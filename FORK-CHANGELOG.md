...
- Rotating left and right are two icons at the top of the menu rather than a "Rotate" submenu to open first. Rotating by 180 is gone from the viewer — it is either icon tapped twice.
